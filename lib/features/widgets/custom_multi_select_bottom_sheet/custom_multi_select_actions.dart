...
class CustomMultiSelectActions<V> {
  ...
  void onConfirmTap(BuildContext ctx, List<V> selectedValues, Function(List<V>)? onConfirm) {
  ...
  List<CustomMultiSelectItem<V>> updateSearchQuery(String? val, List<CustomMultiSelectItem<V>> allItems) {
    if (val != null && val.trim().isNotEmpty) {
      List<CustomMultiSelectItem<V>> filteredItems = [];
