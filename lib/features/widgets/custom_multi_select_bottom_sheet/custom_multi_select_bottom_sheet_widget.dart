...
import 'package:pratudo/features/widgets/custom_multi_select_bottom_sheet/custom_multi_select_bottom_sheet.dart';
...
class __MultiSelectBottomSheetFieldViewState<V> extends State<_MultiSelectBottomSheetFieldView<V>> {
  ...
  Widget _buildInheritedChipDisplay() {
    List<CustomMultiSelectItem<V>?> chipDisplayItems = [];
    chipDisplayItems =
