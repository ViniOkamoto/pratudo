...
import 'package:pratudo/features/widgets/custom_multi_select_bottom_sheet/custom_multi_select_actions.dart';
...
class CustomMultiSelectBottomSheet<V> extends StatefulWidget with CustomMultiSelectActions<V> {
  ...
  @override
  _CustomMultiSelectBottomSheetState<V> createState() => _CustomMultiSelectBottomSheetState<V>(items);
}

class _CustomMultiSelectBottomSheetState<V> extends State<CustomMultiSelectBottomSheet<V>> {
  List<V> _selectedValues = [];
  bool _showSearch = false;
  List<CustomMultiSelectItem<V>> _items;
  ...
  Widget _buildListItem(CustomMultiSelectItem<V> item) {
    return Theme(
      data: ThemeData(
        unselectedWidgetColor: widget.unselectedColor ?? Colors.black54,
        colorScheme:
            ColorScheme.fromSwatch().copyWith(secondary: widget.selectedColor ?? Theme.of(context).primaryColor),
      ),
  ...
  Widget _buildChipItem(CustomMultiSelectItem<V> item) {
    return Container(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  focusedBorder: UnderlineInputBorder(
                                    borderSide:
                                        BorderSide(color: widget.selectedColor ?? Theme.of(context).primaryColor),
                                  ),
                                ),
                                onChanged: (val) {
                                  setState(() {
