...
abstract class RecipeRepository {
  ...
  Future<Either<Failure, ExperienceGainedModel>> createRecipe(RecipeCreationModel recipeCreation);
}
...
class RecipeRepositoryImpl implements RecipeRepository {
  ...
  @override
  Future<Either<Failure, ExperienceGainedModel>> createRecipe(RecipeCreationModel recipeCreation) async {
    try {
      log(recipeCreation.toJson().toString());
